...
- (id)initWithFrame:(CGRect)frame withShowType:(ButtonShowType)type {
...
- (void)updateConstraints{
    ...
    if (showType == FaceHiddenButtonType) {
    ...
    }else if(showType == MoreHiddenButtonType){
        [self.voiceButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.mas_left).with.offset(10);
            make.top.equalTo(self.mas_top).with.offset(8);
            make.height.equalTo(@28);
    ...
    }else if(showType == VideoHiddenButtonType){
        [self.moreButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.mas_right).with.offset(-10);
            make.top.equalTo(self.mas_top).with.offset(8);
            make.height.equalTo(@28);
    ...
    }else if(showType == FaceAndMoreHiddenType){
        [self.voiceButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.mas_left).with.offset(10);
            make.top.equalTo(self.mas_top).with.offset(8);
            make.height.equalTo(@28);
    ...
    }else if(showType == FaceAndMoreAndVideoButtonHiddenType){
        [self.textView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.mas_left).with.offset(10);
            make.right.equalTo(self.mas_right).with.offset(-10);
            make.top.equalTo(self.mas_top).with.offset(4);
    ...
    }else if(showType == VideoAndFaceButtonHiddenType){
        [self.moreButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.mas_right).with.offset(-10);
            make.top.equalTo(self.mas_top).with.offset(8);
            make.height.equalTo(@28);
    ...
    }else if( showType == VideoAndMoreButtonHiddenType) {
        [self.faceButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.mas_right).with.offset(-10);
            make.top.equalTo(self.mas_top).with.offset(8);
            make.height.equalTo(@28);
...
- (void)setCustomButtonReplaceVoiceButton:(UIImage *)image withBlock:(Completion)com {
    ...
    [self.voiceButton setBackgroundImage:image forState:UIControlStateNormal];
    ComBlock = com;
}
 ...
 *  @param seconds   语音时长
 */
- (void)sendVoiceMessage:(NSData *)videoData seconds:(NSTimeInterval)seconds{
    if (self.delegate && [self.delegate respondsToSelector:@selector(chatBar:sendVoice:seconds:)]) {
        [self.delegate chatBar:self sendVoice:videoData seconds:seconds];
    }
}
