...
typedef NS_ENUM(NSInteger, ButtonShowType) {
    ButtonShowDefaultType,
    FaceHiddenButtonType,
    MoreHiddenButtonType,
    VideoHiddenButtonType,
    FaceAndMoreHiddenType,
    VideoAndFaceButtonHiddenType,
    VideoAndMoreButtonHiddenType,
    FaceAndMoreAndVideoButtonHiddenType,
};
